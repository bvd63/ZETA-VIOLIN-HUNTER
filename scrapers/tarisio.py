"""
Tarisio.com scraper — Violin-specific auctions (CRITICAL!).
"""
...
class TarisioScraper(BaseScraper):
    name = "Tarisio"
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for kw in keywords:
                try:
                    url = "https://www.tarisio.com/cgi-bin/lotfind.pl"
                    params = {
                        "keyword": kw,
                        "category": "violin",
                    }
                    ...
                    for item in listings:
                        ...
                        unique_id = self._make_id("tarisio", item_url)
                    ...
                    log.warning(f"Tarisio '{kw}' error: {e}")
