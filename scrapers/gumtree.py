"""
Gumtree.com scraper — UK & Australia classifieds.
"""
...
class GumtreeScraper(BaseScraper):
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for city, location_code in self.GUMTREE_LOCATIONS:
                for kw in keywords:
                    try:
                        url = f"https://www.gumtree.com/{location_code}/search"
                        params = {
                            "search_category": "musical_instruments",
                            "search_text": kw,
                        }
                        ...
                        for item in listings:
                            ...
                            unique_id = self._make_id("gumtree", item_url)
                        ...
                        log.warning(f"Gumtree {city} '{kw}' error: {e}")
