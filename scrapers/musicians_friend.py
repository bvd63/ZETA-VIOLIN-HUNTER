"""
Musician's Friend scraper — USA music gear (used section).
"""
...
class MusiciansFriendScraper(BaseScraper):
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for kw in keywords:
                try:
                    url = "https://www.musiciansfriend.com/search"
                    params = {
                        "q": kw,
                        "condition": "used",
                    }
                    ...
                    for item in listings:
                        ...
                        unique_id = self._make_id("musicians_friend", item_url)
                    ...
                    log.warning(f"Musician's Friend '{kw}' error: {e}")
