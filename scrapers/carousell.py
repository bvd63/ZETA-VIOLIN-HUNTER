"""
Carousell.com scraper — Southeast Asia marketplace.
"""
...
class CarousellScraper(BaseScraper):
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for region in self.CAROUSELL_REGIONS:
                for kw in keywords:
                    try:
                        url = f"https://www.carousell.com/search/{region}"
                        params = {
                            "query": kw,
                        }
                        ...
                        for item in listings:
                            ...
                            unique_id = self._make_id("carousell", item_url)
                        ...
                        log.warning(f"Carousell {region} '{kw}' error: {e}")
