"""
Lazada scraper — Southeast Asia marketplace.
"""
...
class LazadaScraper(BaseScraper):
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for country, country_code in self.LAZADA_COUNTRIES:
                for kw in keywords:
                    try:
                        url = f"https://www.lazada.{country_code}/search"
                        params = {
                            "q": kw,
                        }
                        ...
                        for item in listings:
                            ...
                            unique_id = self._make_id("lazada", item_url)
                        ...
                        log.warning(f"Lazada {country} '{kw}' error: {e}")
