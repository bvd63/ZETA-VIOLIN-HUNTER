"""
Invaluable.com scraper — Global auctions.
"""
...
class InvaluableScraper(BaseScraper):
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for kw in keywords:
                try:
                    url = "https://www.invaluable.com/search"
                    params = {
                        "q": kw,
                    ...
                    for item in listings:
                        ...
                        unique_id = self._make_id("invaluable", item_url)
                    ...
                    log.warning(f"Invaluable '{kw}' error: {e}")
