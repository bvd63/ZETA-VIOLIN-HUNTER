"""
Sweetwater.com scraper — USA music gear (used section).
"""
...
class SweetwaterScraper(BaseScraper):
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for kw in keywords:
                try:
                    url = "https://www.sweetwater.com/search"
                    params = {
                        "q": kw,
                        "condition": "used",
                    }
                    ...
                    for item in listings:
                        ...
                        unique_id = self._make_id("sweetwater", item_url)
                    ...
                    log.warning(f"Sweetwater '{kw}' error: {e}")
