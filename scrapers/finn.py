...
class FinnScraper(BaseScraper):
    ...
    async def search(self) -> list:
        ...
        keywords = [
            "Zeta fiolin", "elektrisk fiolin Zeta",
            "elektrisk fiolin", "MIDI fiolin", "5-strenget fiolin",
        ]

        async with httpx.AsyncClient(timeout=15) as client:
            for city in self.NORWEGIAN_CITIES:
                for kw in keywords:
                    try:
                        url = "https://www.finn.no/search"
                        params = {
                            "q": kw,
                            "location": city,
                        }
                        ...
                        for item in listings:
                            ...
                            unique_id = self._make_id("finn", item_url)
                        ...
                        log.warning(f"Finn {city} '{kw}' error: {e}")
