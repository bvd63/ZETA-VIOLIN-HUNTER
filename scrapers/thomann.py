"""
Thomann.de scraper — German music gear (used section).
"""
...
class ThomannScraper(BaseScraper):
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for kw in keywords:
                try:
                    url = "https://www.thomann.de/search"
                    params = {
                        "q": kw,
                        "condition": "used",
                    }
                    ...
                    for item in listings:
                        ...
                        unique_id = self._make_id("thomann", item_url)
                    ...
                    log.warning(f"Thomann '{kw}' error: {e}")
