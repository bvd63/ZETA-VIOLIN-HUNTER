"""
Sotheby's.com scraper — Global auctions.
"""
...
class SothebysScaper(BaseScraper):
    name = "Sotheby's"
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for kw in keywords:
                try:
                    url = "https://www.sothebys.com/en/search"
                    params = {
                        "q": kw,
                    ...
                    for item in listings:
                        ...
                        unique_id = self._make_id("sothebys", item_url)
                    ...
                    log.warning(f"Sotheby's '{kw}' error: {e}")
