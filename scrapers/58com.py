"""
58.com scraper — Chinese classifieds.
"""
...
class Com58Scraper(BaseScraper):
    name = "58.com"
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for city in self.CHINESE_CITIES:
                for kw in keywords:
                    try:
                        url = f"https://{city}.58.com/search"
                        params = {
                            "keywords": kw,
                            "catid": "1234",  # Musical instruments
                        }
                        ...
                        for item in listings:
                            ...
                            unique_id = self._make_id("58com", item_url)
                        ...
                        log.warning(f"58.com {city} '{kw}' error: {e}")
