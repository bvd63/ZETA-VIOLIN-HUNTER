"""
Blocket.se scraper — Swedish classifieds.
"""
...
class BlocketScraper(BaseScraper):
    ...
    async def search(self) -> list:
        ...
        keywords = [
            "Zeta fiol", "elektrisk fiol Zeta",
            "elektrisk fiol", "MIDI fiol", "5-strängad fiol",
        ]

        async with httpx.AsyncClient(timeout=15) as client:
            for city in self.SWEDISH_CITIES:
                for kw in keywords:
                    try:
                        ...
                        for item in listings:
                            ...
                            unique_id = self._make_id("blocket", item_url)
                        ...
                        log.warning(f"Blocket {city} '{kw}' error: {e}")
