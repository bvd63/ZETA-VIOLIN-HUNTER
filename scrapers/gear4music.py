"""
Gear4music.com scraper — UK music gear (used section).
"""
...
class Gear4musicScraper(BaseScraper):
    name = "Gear4music"
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for kw in keywords:
                try:
                    url = "https://www.gear4music.com/search"
                    params = {
                        "q": kw,
                        "condition": "used",
                    }
                    ...
                    for item in listings:
                        ...
                        unique_id = self._make_id("gear4music", item_url)
                    ...
                    log.warning(f"Gear4music '{kw}' error: {e}")
