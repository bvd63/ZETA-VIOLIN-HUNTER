"""
Christie's.com scraper — Global auctions.
"""
...
class ChristiesScraper(BaseScraper):
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for kw in keywords:
                try:
                    url = "https://www.christies.com/en/search"
                    params = {
                        "q": kw,
                    ...
                    for item in listings:
                        ...
                        unique_id = self._make_id("christies", item_url)
                    ...
                    log.warning(f"Christie's '{kw}' error: {e}")
