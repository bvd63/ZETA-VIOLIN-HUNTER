"""
Vintage King scraper — USA vintage gear.
"""
...
class VintageKingScraper(BaseScraper):
    name = "Vintage King"
    ...
    async def search(self) -> list:
        ...
        async with httpx.AsyncClient(timeout=15) as client:
            for kw in keywords:
                try:
                    url = "https://www.vintageking.com/search"
                    params = {
                        "q": kw,
                    }
                    ...
                    for item in listings:
                        ...
                        unique_id = self._make_id("vintage_king", item_url)
                    ...
                    log.warning(f"Vintage King '{kw}' error: {e}")
