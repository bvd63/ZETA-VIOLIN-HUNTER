...
- CONDITION (default "used" = second-hand only, drops New/Brand New/Open box/B-Stock + dealers + shop language; "all" = no filter — tried for one run on 2026-09-10, owner rejected it: every alert was new dealer stock)
